  ...
  layers: [
    {
      ...
      tools: [
        { name: "LLMs & OpenAI", note: "OpenAI and other LLM APIs behind typed Python services, for generation, chat and extraction.", projects: ["cliniwise-ai", "amplify-ai", "blogbuster"] },
        { name: "RAG pipelines", note: "Retrieval-augmented generation over vector search, with citations and access filtering before retrieval.", projects: ["amplify-ai"] },
    ...
    },
    {
      ...
      tools: [
        { name: "Python", note: "Primary language for services, background workers and AI pipelines.", projects: ["cliniwise-ai", "amplify-ai", "amplify-ingestion", "blogbuster", "auth-module"] },
        { name: "FastAPI", note: "Async APIs for microservices and AI backends.", projects: ["cliniwise-ai", "amplify-ai", "amplify-ingestion", "blogbuster"] },
        ...
        { name: "OpenID Connect & OAuth 2.0", note: "Standards-based authentication with security tests and production configuration.", projects: ["auth-module", "amplify-ai"] },
    ...
    },
    {
      ...
      tools: [
        { name: "PostgreSQL", note: "The system of record for services, jobs and application data.", projects: ["cliniwise-ai", "amplify-ai", "amplify-ingestion", "blogbuster"] },
        { name: "pgvector", note: "Vector search inside PostgreSQL, next to the relational data it belongs to.", projects: ["amplify-ai"] },
    ...
    },
    {
      ...
      tools: [
        ...
        { name: "Azure", note: "About 2 years in production, plus an isolated deployment in private subnets for a client with strict data privacy requirements.", projects: ["cliniwise-ai", "amplify-ai", "amplify-ingestion"] },
        { name: "GCP", note: "Part of multi-cloud deployments alongside AWS and Azure.", projects: ["cliniwise-ai"] },
        { name: "Docker", note: "Containerised services that run the same way in every environment.", projects: ["amplify-ai", "amplify-ingestion"] },
